...
const Blog = () => {
    ...
    const {
        comments_counts, title, reading_time_minutes, public_reactions_count, published_at
    } = blog;
    return (
            ...
            <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center dark:text-gray-600">
                        ...
                        <p className="flex-shrink-0 mt-3 text-sm md:mt-0">{comments_counts} comments . {public_reactions_count} views</p>
                    </div>
                </div>
                {/* tabs */}
                <div className="dark:text-gray-800">
                    <div className="flex items-start -mx-4 overflow-x-auto overflow-y-hidden  flex-nowrap dark:bg-gray-100 dark:text-gray-800">
                        <Link onClick={() => setTab(0)} className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tab === 0 ? ' border border-b-0' : 'border-b'}
                        ...
                        <Link  onClick={() => setTab(1)} className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2  ${tab === 1 ? 'border  border-b-0' : 'border-b'}   rounded-t-lg dark:border-gray-600 dark:text-gray-900`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
